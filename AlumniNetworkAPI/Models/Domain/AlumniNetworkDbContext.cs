    ...
    public class AlumniNetworkDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Event>().HasData(
                new Event { Id = 1, Name = "Introduction to Machine Learning", Description = "Join us for an online workshop on the basics of machine learning. Learn about various algorithms and techniques used in machine learning.", AllowGuests = true, BannerImage = "machinelearning.jpg", StartTime = new DateTime(2023, 3, 5, 10, 0, 0), EndTime = new DateTime(2023, 3, 5, 18, 0, 0) },
                new Event { Id = 2, Name = "Alumni Networking Mixer", Description = "Join us for an evening of networking and socializing with fellow alumni. Make new connections, catch up with old friends, and expand your professional network.", AllowGuests = true, BannerImage = "networking.jpg", StartTime = new DateTime(2023, 3, 10, 10, 0, 0), EndTime = new DateTime(2023, 3, 10, 18, 0, 0) },
                new Event { Id = 3, Name = "Community Service Project", Description = "Join us for a community service project to give back to the community. Help us clean up a local park and make it a better place for everyone.", AllowGuests = true, BannerImage = "communityservice.jpg", StartTime = new DateTime(2023, 3, 15, 10, 0, 0), EndTime = new DateTime(2023, 3, 15, 18, 0, 0) },
                new Event { Id = 4, Name = "Alumni Homecoming 2023", Description = "Join us for the annual alumni homecoming event. Reconnect with old friends, meet new ones, and celebrate the university's legacy.", AllowGuests = true, BannerImage = "homecoming.jpg", StartTime = new DateTime(2023, 3, 20, 10, 0, 0), EndTime = new DateTime(2023, 3, 20, 18, 0, 0) },
                new Event { Id = 5, Name = "Career Fair 2023", Description = "Looking for new job opportunities? Join us for the annual career fair, where you can network with employers and learn about job openings.", AllowGuests = false, BannerImage = "careerfair.jpg", StartTime = new DateTime(2023, 3, 25, 10, 0, 0), EndTime = new DateTime(2023, 3, 25, 18, 0, 0) }
            );
