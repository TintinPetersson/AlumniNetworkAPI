    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, null, "machinelearning.jpg", "Join us for an online workshop on the basics of machine learning. Learn about various algorithms and techniques used in machine learning.", new DateTime(2023, 4, 5, 18, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Introduction to Machine Learning", new DateTime(2023, 4, 5, 10, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, true, null, "networking.jpg", "Join us for an evening of networking and socializing with fellow alumni. Make new connections, catch up with old friends, and expand your professional network.", new DateTime(2023, 4, 10, 18, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Alumni Networking Mixer", new DateTime(2023, 4, 10, 10, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, true, null, "communityservice.jpg", "Join us for a community service project to give back to the community. Help us clean up a local park and make it a better place for everyone.", new DateTime(2023, 4, 15, 18, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Community Service Project", new DateTime(2023, 3, 15, 10, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 4, true, null, "homecoming.jpg", "Join us for the annual alumni homecoming event. Reconnect with old friends, meet new ones, and celebrate the university's legacy.", new DateTime(2023, 4, 20, 18, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Alumni Homecoming 2023", new DateTime(2023, 4, 20, 10, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 5, false, null, "careerfair.jpg", "Looking for new job opportunities? Join us for the annual career fair, where you can network with employers and learn about job openings.", new DateTime(2023, 4, 25, 18, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Career Fair 2023", new DateTime(2023, 4, 25, 10, 0, 0, 0, DateTimeKind.Unspecified) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "As an electrical engineering major, I have learned a lot during my time in college. Here are some tips for success: 1. Stay organized and manage your time well. 2. Take advantage of networking opportunities. 3. Get hands-on experience through internships or research. 4. Stay up-to-date with the latest technologies and trends. Good luck!", 1, 1, new DateTime(2023, 3, 28, 15, 21, 58, 339, DateTimeKind.Local).AddTicks(223), null, null, "Tips for Electrical Engineering Students", 1 },
                    { 2, 2, "If you're planning to take the bar exam, it's important to start preparing early. Here are some tips: 1. Create a study schedule and stick to it. 2. Take practice exams to get familiar with the format and types of questions. 3. Join a study group to stay motivated and get support. 4. Take care of yourself and manage your stress. You can do it!", 2, 2, new DateTime(2023, 3, 28, 15, 21, 58, 339, DateTimeKind.Local).AddTicks(263), null, null, "Preparing for the Bar Exam", 2 },
                    { 3, 3, "Starting a small business can be challenging, but also very rewarding. Here are some tips to help you get started: 1. Conduct market research to identify a need for your product or service. 2. Create a business plan and set clear goals. 3. Secure funding and resources. 4. Build a strong team and culture. Good luck on your entrepreneurial journey!", 3, 3, new DateTime(2023, 3, 28, 15, 21, 58, 339, DateTimeKind.Local).AddTicks(266), null, null, "Tips for Starting a Small Business", 3 },
                    { 4, 4, "As a medical resident, I have had many challenges and opportunities for growth. Here are some things I have learned: 1. Time management is key. 2. Communication skills are critical. 3. Self-care is important to avoid burnout. 4. Learning is a lifelong process. Best of luck to all medical residents!", 1, 4, new DateTime(2023, 3, 28, 15, 21, 58, 339, DateTimeKind.Local).AddTicks(269), null, null, "My Experience as a Medical Resident", 4 },
                    { 5, 5, "STEM education is crucial for the future of our society and economy. Here are some reasons why: 1. STEM careers are in high demand and offer high salaries. 2. STEM skills are needed for innovation and problem-solving. 3. STEM education can promote diversity and social equality. Let's encourage more young people to pursue STEM education!", 4, 1, new DateTime(2023, 3, 28, 15, 21, 58, 339, DateTimeKind.Local).AddTicks(272), null, null, "The Importance of STEM Education", 1 }
                });
